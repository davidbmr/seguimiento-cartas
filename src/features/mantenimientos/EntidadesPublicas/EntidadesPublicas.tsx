...
import styles from "./EntidadesPublicas.module.css";
import { MainContentStructure } from "@/components/MainContentStructure/MainContentStructure";
import { useNavigate } from "react-router-dom";

export const EntidadesPublicas: React.FC = () => {
	...
	const listadoProyectos: any = [
		{
			id: 1,
			nombre: "Entidad pública A",
		},
		{
			id: 2,
			nombre: "Entidad pública B",
		},
	];
	...
	return (
		<MainContentStructure titleText="Listado de Entidades Públicas">
			<div className={styles.tableContainer}>
				<DataTable
					columns={columnsInteresados}
					data={listadoProyectos || []}
					textAddButton="Agregar Entidad Pública"
